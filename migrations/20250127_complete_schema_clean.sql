-- Complete Database Schema & RLS Migration (Clean Version)
-- Migration: 20250127_complete_schema_clean.sql
...
-- Activity ticker view (last 50 events) - FIXED JSONB syntax
