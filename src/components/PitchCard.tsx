...
export default function PitchCard({ data, variant = 'default' }: Props) {
  ...
  return (
    <div 
      data-test="pitch-card" 
      className={`
        group relative bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden 
        hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 
        transform hover:-translate-y-2 hover:scale-[1.02]
        ${variant === 'featured' ? 'ring-2 ring-blue-500/20 shadow-lg' : ''}
      `}
    >
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            {photo_url ? (
              ...
              <div className="relative">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg ring-4 ring-white">
