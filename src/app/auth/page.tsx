      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Welcome Recruiters & Supporters!
          </h2>
          <p className="text-gray-600 mb-6">
            Sign in to access your dashboard and support military veterans
          </p>
        </div>

        {/* Recruiter & Supporter Welcome */}
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
          <div className="text-center">
            ...
            <p className="text-sm text-green-700 mb-4">
              Join our community of recruiters and supporters helping military veterans transition to civilian careers.
            </p>
